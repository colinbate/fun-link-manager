...
System.config({
  "map": {
    ...
    "fun-links/app": {
      "fun-links/common/default-value-converter": "fun-links/common/default-value-converter",
      "fun-links/components/alert-centre": "fun-links/components/alert-centre",
      "fun-links/components/link-picker": "fun-links/components/link-picker",
      "fun-links/digests/edit": "fun-links/digests/edit",
      "fun-links/digests/index": "fun-links/digests/index",
      "fun-links/digests/markdown": "fun-links/digests/markdown",
      "fun-links/digests/new": "fun-links/digests/new",
      "fun-links/digests/view": "fun-links/digests/view",
      "fun-links/endpoints/list": "fun-links/endpoints/list"
    },
